...
class Map_Obj():
    ...
    def read_map(self, path: str) -> [np.ndarray, str]:
        """
    ...
    def fill_critical_positions(self, task: int) -> [[int], [int],
                                                          [int], str]:
        """
    ...
    def get_maps(self) -> [np.ndarray, str]:
    ...
    def move_goal_pos(self, pos: [int, int]):
        """
    ...
    def set_cell_value(self, pos: [int, int], value: int,
                       str_map: bool = True):
    ...
    def replace_map_values(self, pos: [int, int], value: int,
                           goal_pos: [int, int]):
    ...
    def set_start_pos_str_marker(self, start_pos: [int, int],
                                 themap: [np.ndarray, str]):
    ...
    def set_goal_pos_str_marker(self, goal_pos: [int, int],
                                themap: [np.ndarray, str]):
    ...
    def show_map(self, themap: [np.ndarray, str] = None):
        ...
        # Show image
        #Give the image an appropriate title
